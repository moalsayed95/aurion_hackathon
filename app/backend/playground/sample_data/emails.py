...
# Scenario 3: Request more info — vague description, missing policy number
...
SCENARIOS = {
    "1": ("Auto-Process (Maria Huber, Wasserschaden)", SCENARIO_AUTO_PROCESS),
    "2": ("Escalate (Thomas Wagner, Brandschaden)", SCENARIO_ESCALATE),
    "3": ("Request Info (Anna Berger, Autoschaden)", SCENARIO_REQUEST_INFO),
}
